...
write.table(yearoutput_loop, file = paste("yearoutput_loop_0.2.csv",sep=""), sep = ",", col.names = F, qmethod = "double", append = T)
write.table(yearsoutput_loop, file = paste("yearsoutput_loop_0.2.csv",sep=""), sep = ",", col.names = F, qmethod = "double",append = T)
