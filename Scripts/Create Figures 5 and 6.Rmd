...
sleepy_id <- 11885
waddledata <- get_waddle(sleepy_id = sleepy_id, year = curyear)
...
# Figure 6 2009 Tb and movement rate with and without water-limited activity
...
allforage <- allforage_2009
allnoforage <- allnoforage_2009

# find times when lizards were moving and not moving
allforage <- subset(allforage,  subset = (Steps > threshold.act))
curyear <- 2009

filename=paste("Figure 6.pdf",sep="") 
pdf(filename,paper="A4",width=11,height=15) 

par(mfrow = c(4, 1)) # set up for 2 plots in 2 columns
par(oma = c(2, 2, 2, 2) + 0.1) # margin spacing
par(mar = c(5, 5, 2, 1) + 0.1) # margin spacing 
par(mgp = c(3, 1, 0) ) # margin spacing
...
with(plotpred, {plot(TC~dates, type = "l",ylim = c(0, 40),ylab = "",xlab = "", cex.axis = 1.5, cex.lab = 1.5, main = 'a) male 11129 observed and predicted body temperature', cex.main = 1.5)})
mtext(text = expression(temperature~(degree*C)),side = 2, padj = -1.5)
mtext(text = "date",side = 1, padj = 4)
...
# plot night hours
with(environ_night, {plot(TIME+2~JULDAY, xlim = c(startdy, finishdy), ylim = c(0, 25), xlab = "day of year", ylab = "hour of day", cex = 0.5, col = "dark grey", pch = 16, main = "b) male 11129 observed and predicted activity", cex.lab = 1.5, cex.main = 1.5)})
...
# Part c, active individual 12434
...
# plot predicted Tb trace
with(plotpred, {plot(TC~dates, type = "l",ylim = c(0, 40),ylab = "",xlab = "", cex.axis = 1.5, cex.lab = 1.5, main = "c) male 12434 observed and predicted body temperature", cex.main = 1.5)})
mtext(text = expression(temperature~(degree*C)),side = 2, padj = -1.5)
mtext(text = "date",side = 1, padj = 4)
...
# plot night hours
with(environ_night, {plot(TIME+2~JULDAY, xlim = c(startdy, finishdy), ylim = c(0, 25), xlab = "day of year", ylab = "hour of day", cex = 0.5, col = "dark grey", pch = 16, main = "d) male 12434 observed and predicted activity", cex.lab = 1.5, cex.main = 1.5)})
