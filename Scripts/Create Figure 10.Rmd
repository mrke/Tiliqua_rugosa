---
title: "Create Figure 10 - sample weight and length trajectories"
...
vignette: >
  %\VignetteIndexEntry{Create Figure 10 - sample weight and length trajectories}
...
filename=paste("Figure 10.pdf",sep="") 
pdf(filename,paper="A4",width=11,height=15) 

par(mfrow = c(4, 1)) # set up for 4 plots in 1 columns
