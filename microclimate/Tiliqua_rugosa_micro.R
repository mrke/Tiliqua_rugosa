...
ystart <- 1991# start year for weather generator calibration dataset or AWAP database
yfinish <- 2010# end year for weather generator calibration dataset
...
# PWP<-(-1.304+1.117*soilpro$clay-0.009309*soilpro$clay^2)/100
# setwd(prevdir)
# write.table(cbind(1,longlat[1],longlat[2],soilpro), file = "c:/git/ectotherm/sleepy/soilprops.txt", sep = ",", col.names = F, qmethod = "double", append = T)
#    
# pre-extracted
soilpro<-read.csv("microclimate/soilprops.txt",header=FALSE)
...
# get output
metout<-as.data.frame(nicheout$metout) # above ground microclimatic conditions, min shade
shadmet<-as.data.frame(nicheout$shadmet) # above ground microclimatic conditions, max shade
soil<-as.data.frame(nicheout$soil) # soil temperatures, minimum shade
shadsoil<-as.data.frame(nicheout$shadsoil) # soil temperatures, maximum shade
soilmoist<-as.data.frame(nicheout$soilmoist) # soil water content, minimum shade
shadmoist<-as.data.frame(nicheout$shadmoist) # soil water content, maximum shade
humid<-as.data.frame(nicheout$humid) # soil humidity, minimum shade
shadhumid<-as.data.frame(nicheout$shadhumid) # soil humidity, maximum shade
soilpot<-as.data.frame(nicheout$soilpot) # soil water potential, minimum shade
shadpot<-as.data.frame(nicheout$shadpot) # soil water potential, maximum shade
...
plot(metout$TALOC~dates,type='l',col = "red",lty=1,ylim = c(-10,80),main=CampNormTbl9_1[soiltype,1],ylab='moisture (% vol)',xlab='date')


plot(soilmoist$dates, soilmoist[,4]*100,type='l',col = "red",lty=1,ylim = c(0,50),main=CampNormTbl9_1[soiltype,1],ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,5]*100,type='l',col = 3,lty=1,ylim = c(0,50),main=CampNormTbl9_1[soiltype,1],ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,6]*100,type='l',col = 4,lty=1,ylim = c(0,50),main=CampNormTbl9_1[soiltype,1],ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,7]*100,type='l',col = 5,lty=1,ylim = c(0,50),main=CampNormTbl9_1[soiltype,1],ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,8]*100,type='l',col = 6,lty=1,ylim = c(0,50),main=CampNormTbl9_1[soiltype,1],ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,9]*100,type='l',col = 7,lty=1,ylim = c(0,50),main=CampNormTbl9_1[soiltype,1],ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,10]*100,type='l',col = 8,lty=1,ylim = c(0,50),main=CampNormTbl9_1[soiltype,1],ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,11]*100,type='l',col = 9,lty=1,ylim = c(0,50),main=CampNormTbl9_1[soiltype,1],ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,12]*100,type='l',col = 10,lty=1,ylim = c(0,50),main=CampNormTbl9_1[soiltype,1],ylab='moisture (% vol)',xlab='date')
points(soilmoist$dates, soilmoist[,13]*100,type='l',col = 11,lty=1,ylim = c(0,50),main=CampNormTbl9_1[soiltype,1],ylab='moisture (% vol)',xlab='date')

xlimit<-c(min(dates),max(dates))
...
plot(plotsoilpot$dates, plotsoilpot[,4],type='l',col = "red",lty=1,ylim = c(-1500,0),main=CampNormTbl9_1[soiltype,1],ylab='water potential (J/kg)',xlab='date')
